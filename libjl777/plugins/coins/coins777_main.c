...
STRUCTNAME COINS;
char *PLUGNAME(_methods)[] = { "acctpubkeys",  "packblocks", "sendrawtransaction", "setmultisig" };
char *PLUGNAME(_pubmethods)[] = { "acctpubkeys", "setmultisig" };
    ...
    else
    {
        ...
        else
        {
            ...
            if ( strcmp(methodstr,"acctpubkeys") == 0 )
            {
                ...
                add_MGWaddr(0,sender,1,jsonstr);
