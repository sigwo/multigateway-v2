...
struct ledger_addrinfo { uint32_t balance[2],txindex,count:28,notify:1,pending:1,MGW:1,dirty:1; uint32_t unspentinds[]; };
...
struct ledger_info
{
    ...
    struct ledger_state ledger,revaddrs,addrs,txids,scripts,blocks,unspentmap,txoffsets,spentbits,addrinfos,addrtx;
