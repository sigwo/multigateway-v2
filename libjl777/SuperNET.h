...
struct InstantDEX_quote { struct InstantDEX_quote *baseiQ,*reliQ; uint64_t quoteid,baseamount,relamount,nxt64bits;  uint32_t timestamp; uint8_t closed:1,sent:1,matched:1,isask:1,pad2:4,pad:8; char exchangeid,gui[9]; };
